...
export class PostServiceService {
   ...
   * @returns Lista de todos los posts
   */
  getAll(): Post[] {
   ...
   * @param categoria La categoría de los posts a filtrar
   * @returns Lista de posts que pertenecen a la categoría especificada
   */
  ...
  /**
   * Crear un nuevo post
   * @param nuevoPost El nuevo post a añadir
   */
